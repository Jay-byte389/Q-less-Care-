...
function HomePage() {
  ...
  const dept = [neurology,dentist,dermatology,cardiology,pediatric,orthopedic];
  var i = 0;
  useEffect(() => {
  ...
  return (
    ...
    < >
      ...
      <div>
        ...
        <image src={banner} alt="Background Image" className="hero-background-image" />
        <h1 className="hero-title">Q-Less Care</h1>
        <p className="hero-subtitle"></p>
        {loggedIn?<a href="/patient/bookappointment" className="explore-button">Book Appointment</a> : <a href="/login" className="explore-button">Book Appointment</a>}
      </div> 
      <br /><br />
